 ...
 */
bool changeProgramCallback(keyence_scanner::ChangeProgram::Request& req,
                           keyence_scanner::ChangeProgram::Response& res,
...
int main(int argc, char** argv)
{
  ...
  pc_msg->is_dense = true; // cloud could have NaNs
  ...
  while (ros::ok())
  {
    try
    {
      ...
      ros::ServiceServer program_server =
          nh.advertiseService<keyence_scanner::ChangeProgram::Request,
                              keyence_scanner::ChangeProgram::Response>(
